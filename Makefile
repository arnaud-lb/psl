...
benchmark-extension-math:
	cd extension; cargo build -r
	php vendor/bin/phpbench run --config config/phpbench.json --tag=php --group math --php-config='$(php-config)'
	php vendor/bin/phpbench run --config config/phpbench.json --tag=extension --ref=php --group math --php-config='$(php-extension-config)'
